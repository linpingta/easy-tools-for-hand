...
class TSI(object):
	...
	def __init__(self, conf):
		...
		try:
			...
			self.conn = None
			self.cur = None
		self.ad_client_host = None
		self.ad_client_port = None
		self.stats_client_host = None
		self.stats_client_port = None
		self.user_client_host = None
		self.user_client_port = None
